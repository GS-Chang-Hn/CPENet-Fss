    ...
    with torch.no_grad():
        for run in range(_config['n_runs']):
            ...
            for sample_batched in tqdm.tqdm(testloader):
                ...
                query_pred, _ = model(support_images, support_slic_images, support_fg_mask, support_bg_mask,
                                      query_images, query_slic_images, support_images_ids, query_images_id)  # 1 2 417 417 有值
