...
# @FileName: fewshot.py
# @Software: PyCharm
# @Description：Few-shot 前景+背景+vit   backbone resnet101 时间2021-11-23
...
# writer = SummaryWriter('run_101/vit_visual')
...
class FewShotSeg(nn.Module):
    ...
    def forward(self, supp_imgs, fore_mask, back_mask, qry_imgs):
        ...
        img_fts_resnet_out = self.encoder(imgs_concat)  # 2 1024 56 56
