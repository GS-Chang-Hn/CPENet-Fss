...
def cfg():
    ...
    if mode == 'train':
        ...
        label_sets = 0
        batch_size = 1
        lr_milestones = [1000, 5000, 10000, 20000, 25000, 30000, 40000, 50000, 60000]
        align_loss_scaler = 1
        ignore_label = 255
        print_interval = 100
        ...
        notrain = False
        snapshot = './Results/CCG_Test_VOC_align_sets_0_1way_1shot_[train]/1/snapshots/60000.pth'
        n_runs = 4
        n_steps = 1000
        batch_size = 1
        scribble_dilation = 0
    ...
    path = {
        'log_dir': './Results',
        # 'init_path': './pretrained_model/resnet101.pth',
        'init_path': './pretrained_model/vgg16-397923af.pth',
        # 'VOC': {'data_dir': './data/VOCdevkit/VOC2012/',
        'VOC': {'data_dir': 'Z:\\czb\\data_copy\\data\\VOC2012\\',
                'data_split': 'trainaug', },
        # 'COCO': {'data_dir': 'Z:\\czb\\coco\\train2014',
        #         'data_split': 'train',},
    }
